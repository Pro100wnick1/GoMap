...
// prosta funkcja sprawdzająca czy punkt należy do prostokątu
...
// funkcja która sprawdza czy funkcja się przecina
...
// struktura dla naszego dungeona
type Dungeon struct {
	Grid                                       [][]int
...
// sprawdzenie czy punkt należy do regionu (tzn czy należy do regionu ścian/podłogi), a następnie zależnie od tego czy należy czy nie, ustawia także odpowiedni region dla sąsiadów
...
// funkcja która odpowiada za całą generacje
...
// wyświetlanie w terminalu naszego wygenerowanego dungeonu
